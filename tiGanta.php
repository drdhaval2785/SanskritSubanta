...
if ( in_array($fo,$aniditverbs) && sub(array("+"),array("Syan","Sna","SnA","Snu","Sa"),array("+"),0)  && $so!=="mahiN")
{
...
/* aniditAM hala upadhAyAH kGiti (6.4.24) */ 
/*if ( in_array($fo,$aniditverbs) && sub(array("+Sap",),array("+"),$apit_sArvadhAtuka_pratyayas,0) )
{
    $text = three(array("N","Y","R","n","m","M"),$hl,array("+","a!+","i!r+","u!"),array("","","","","","",),$hl,array("+","a!+","i!r+","u!"),0);        
	storedata('6.4.24','sa',0);
    $aniditAm = 1; // 0 - this sUtra has not applied. 1 - this sUtra has applied.
...
/* pugantalaghUpadhasya ca (7.3.86) */
elseif (in_array($fo,array("vida!"))  && $didhI!==1 && $ksa!==1 && $vijait!==1 && (pr2(array("vid"),array("+"),$pit_sArvadhAtuka_pratyayas,array("ved"),array("+"),$pit_sArvadhAtuka_pratyayas,$text)!== $text || pr2(array("vid"),array("+"),blank(0),array("ved"),array("+"),blank(0),$text)!== $text) )
{
...
/*if (in_array($fo,array("qukfY","kfY")))
{
	...
	// pending to refactor because of non reference to any sUtra.
...
/* sArvadhAtukArdhadhAtukayoH (7.3.84) */
if ( $didhI!==1 && !($lakAra==="liw" && in_array($fo,array("uN"))) && arr($text,'/[iIuUfFxX]\+[uia]\+/') && ($sarvadhatuka===1 || $ardhadhatuka===1) && !($ad===1 && sub(array("i","I","u","U","f","F","x","X"),array("+"),$ajAdi_apit_sArvadhAtuka_pratyayas,0) ) )
{
...
/* hali ca (8.2.77) */
if ( in_array($so,$tiG) && $karoti!==1  && arr($text,'/[rv]\+/') && sub(array("i","u","f"),array("r+","v+"),$halAdi_apit_sArvadhAtuka_pratyayas,0) )
{
...
/* aniditAM hala upadhAyAH kGiti (6.4.24) */ 
if ( !itcheck(array("i"),1) && arr($text,'/[nM]['.pc('hl').'][+]/') && ( itcheck(array("k","N"),1)|| $ancu===1 ) && !($kruJca===1 && sub(array("krunc","kruYc"),blank(0),blank(0),0) ) && $nance===0 && $so!=="mahiN")
{
...
if (arr($text,'/o/') && sub($dhato,$y,blank(0),0) && $pada ==="pratyaya" && $start ===1)
{
...
if (arr($text,'/as/') && sub(array("sas","ezas"),$hl,blank(0),0)  && !sub(array("asa","anEza"),array("s"),$hl,0) && in_array($fo,array("sas","ezas")))
{
...
if ($dhatu===1 && (arr($text,'/[rv][+]/')|| arr($text,'/[v][n][+]/') ) && $karoti!==1  && !($us==="nis" && in_array($so,$tiG)) && sub($ik,array("r","v"),$hl,0) )
{
