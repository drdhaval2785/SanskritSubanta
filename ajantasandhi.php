...
{
$text3 = two(array($second),array(""),array($second),array("!"),1);
$text = $text3;
...
/*iko yaNaci (6.1.77) */
if(checkarray(prat('ik'),prat('ac'),blank(0),blank(0))===1)
{
...
if(checkarray($go,$aonly,blank(0),blank(0)) === 1)
{
...
if (checkarray($go,prat('ac'),blank(0),blank(0)) === 1)
{
...
/* indre ca (6.1.124) */
if (checkarray($go,array("indra"),blank(0),blank(0)) === 1)
{
...
if (checkarray(prat('ec'),prat('ac'),blank(0),blank(0)) === 1)
{
...
if (checkarray($va3607,blank(0),blank(0),blank(0)) === 1)
{
...
if (checkarray($akarantaupasarga,$verbs_ru,blank(0),blank(0)) === 1)
{
...
$rep = array("e","e","o","o");
if (checkarray($aa,$forguna,blank(0),blank(0)) === 1)
{
...
if (checkarray($akarantaupasarga,prat('eN'),blank(0),blank(0)) === 1)
{
...
$eva = array("eva");
if (checkarray($aa,$eva,blank(0),blank(0)) === 1)
{
...
if (checkarray($shakandhu1,$shakandhu2,blank(0),blank(0)) === 1)
{
...
$otu = array("otu","ozQ");
if (checkarray($aa,$otu,blank(0),blank(0))===1)
{
...
/* omAGozca (6.1.95) */ 
$om = array("om");
if (checkarray($aa,$o,blank(0),blank(0)) === 1)
{
...
$at = array("at");
$iti = array("iti");
if (checkarray($at,$iti,blank(0),blank(0)) === 1)
{
...
if (checkarray($aa,prat('ec'),blank(0),blank(0)) === 1)
{
...
if (checkarray($ak1,$ak2,blank(0),blank(0)) === 1)
{
...
$ruti1 = array("f","F","x","X");
$ruti2 = array("f","f","x","x");
if (checkarray($ruti1,$ruti2,blank(0),blank(0)) === 1)
{
