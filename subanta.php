...
$ancureps = array("praanc","praanc","praanc","praanc","pratianc","pratianc","pratianc","pratianc","udanc","udanc","tirasanc","tirasanc","tirasanc","tirasanc","adasanc","adasanc","adasanc","adasanc");
...
{
    if ( (in_array($so,$sarvanamasthana)|| in_array($so,$tRtIyAdiSvaci) || arr($text,'/[+][S][i]$/')) && $gender==="n") 
    {
...
{ 
    ...
    $text = two(array("krozwan"),array("+"),array("krozwAn"),array("+"),0);
...
$vrasca = array("vfSc","sfj","mfj","yaj","rAj","BrAj","devej","parivrAj","Bfj","ftvij","Bfsj");
$vrashca = array("vfSz","sfz","mfz","yaz","rAz","BrAz","devez","parivrAz","Bfz","ftviz","Bfsz");
