...
$legends = array (
	'balaram' => 'Allocating diacritic marks to characters in the extended ASCII range, commonly used in BBT and ISKCON productions. <a href="http://www.dasya.com/~mbest/freeware/fonts1.html" target="_blank">Read more</a>.',
	'csx' => 'Acronym for Classical Sanskrit eXtended, an encoding allocating characters to extended ASCII range. <a href="http://www.gruntose.com/asynchronous_school/font_project/font_hp.html" target="_blank">Read more</a>.',
	'hk' => 'An ASCII-based transliteration system, including XHK extensions. <a href="http://en.wikipedia.org/wiki/Harvard-Kyoto" target="_blank">Read more</a>.',
	'itrans' => 'Acronym for Indian languages TRANSliteration, an ASCII-based transliteration system. <a href="http://en.wikipedia.org/wiki/ITRANS" target="_blank">Read more</a>',
	"shakti" => "A Mac-based diacritic system, named after a once popular font.",
	"xsanskrit" => "An encoding used in some old BBT and ISKCON productions, input with a tool called KeySans.",
	'velthuis' => 'An ASCII-based transliteration system developed by Frans Velthuis. <a href="http://en.wikipedia.org/wiki/Devanagari_transliteration#Velthuis" target="_blank">Read more</a>',
	'unicode' => 'The standard IAST (International Alphabet of Sanskrit Transliteration) diacritics in Unicode. <a href="http://en.wikipedia.org/wiki/IAST" target="_blank">Read more</a>.',
